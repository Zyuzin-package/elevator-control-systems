...
public class Elevator {
    ...
    /**
     * Метод имитации нажатия на кнопку закрытия двери.
    ...
    /**
     * Метод имитации нажатия на кнопку открытия двери.
     * Не используется т.к. в текущей реализации просиходит автоматически
     */
    ...
    /**
     * Метод имитации нажатия на кнопку вызова диспетчера.
     */
    public void pressDispatcherBtn() {
        System.out.println("Pressing the button to call the dispatcher");
    }
    /**
     * Метод, имитации состояния датчика движения в двери лифта, когда он активен.
     */
    public void doorsMovementListener() {

    }
    /**
     * Метод, имитации состояния датчика движения в двери лифта, когда он не активен.
     */
